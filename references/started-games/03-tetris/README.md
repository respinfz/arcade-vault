...
- **Skins visuales** (Retro, Neon, Pastel, Pixel art): cambian la paleta y el estilo de
  dibujo de los bloques sin recargar; la preferencia se guarda en `localStorage`.
...
| `SKINS`        | Skins visuales (paleta + estilo de dibujo por skin) | `retro` / `neon` / `pastel` / `pixel` |
